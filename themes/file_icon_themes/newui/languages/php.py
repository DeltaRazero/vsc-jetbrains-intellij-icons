...
icons = [
    ...
    icon.LanguageIdIcon(
        {
            ColorTheme.DEFAULT_DARK: icon.LanguageIdIconDefinition("/jetbrains/PhpIcons/icons/expui/php_dark.svg"),
            ColorTheme.LIGHT       : icon.LanguageIdIconDefinition("/jetbrains/PhpIcons/icons/expui/php.svg"),
        },
        language_ids=["php"],
    ),
